...
public class Tail : MonoBehaviour
{
    ...
    public void GetInformation(GameObject Leading, float Distance = 0.9f)
    {
    ...
    // Постоянное движение(каждый хвост - это супер ИИ)
    void Update()
    {
        ...
        // Движение хвоста(опять таки - SUPER II)
        ...
        this.transform.position = Vector3.SmoothDamp(this.transform.position, new Vector3(this.transform.position.x, Leading.transform.position.y, Leading.transform.position.z), ref Zero, 0.05f);
    }
}
